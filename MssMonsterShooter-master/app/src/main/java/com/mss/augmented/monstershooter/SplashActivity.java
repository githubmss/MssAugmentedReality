...
public class SplashActivity extends Activity {
    ...
    public void checkPermission() {
        ...
        int ACCESS_COARSE_LOCATION_PREMISSION = ContextCompat.checkSelfPermission(SplashActivity.this, android.Manifest.permission.CAMERA);
        ...
        if (ACCESS_COARSE_LOCATION_PREMISSION == PackageManager.PERMISSION_GRANTED && ACCESS_FINE_LOCATION_PREMISSION == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(ctx, new String[]{ android.Manifest.permission.CAMERA, android.Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_READ_EXTERNALSTORAGE_PERMISSION);
        }
    }
    @Override
